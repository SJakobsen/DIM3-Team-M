...
var Boat, Lake, World, buybait, buybaitCallback, buybaitRequest, buyboat, buyboatCallback, buyboatRequest, changebate, changebateCallback, changebateRequest, currentX, currentY, finish, finishCallback, finishRequest, fish, fishCallback, fishRequest, initUI, lake, move, moveCallback, moveRequest, newGame, newgameCallback, newgameRequest, nextX, nextY, origin, print, sendRequest, showFishingResults, unwaitUI, waitUI, world;
...
moveCallback = function(data) {
  ...
  if (status === "ok") {
    ...
    return world.updateScene();
  }
};

fishCallback = function(data) {
  return showFishingResults(data);
};
...
showFishingResults = function(result) {
  ...
  return $("#fishing-result").html(res);
};
