...
var Boat, Lake, World, buybait, buybaitCallback, buybaitRequest, buyboat, buyboatCallback, buyboatRequest, changebate, changebateCallback, changebateRequest, currentX, currentY, finish, finishCallback, finishRequest, fish, fishCallback, fishRequest, lake, move, moveCallback, moveRequest, newGame, newgameCallback, newgameRequest, nextX, nextY, origin, print, sendRequest, unwaitUI, waitUI, world,
  _this = this;
...
World = (function() {
  ...
  World.prototype.drawBoat = function() {
    if (this.boat) {
      return this.setTile(this.boat.getCurrentX() - 1, this.boat.getCurrentY() - 1, "#ff0000");
    }
  };
